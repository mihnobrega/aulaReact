    ...
    <div>
      ...
      <div className="conteudo">
        ...
        <ul>
          ...
          <p>Na aula do dia 09/09/2025 iremos fazer os 4 exercícios abaixo: </p>

        <ul>
           <li><Link to="/exemplo1">Exercicio 1</Link></li>
            <li><Link to="/exemplo2">Exercicio 2</Link></li>
            <li><Link to="/exemplo1">Exercicio 3</Link></li>
            <li><Link to="/exemplo2">Exercicio 4</Link></li>
        </ul>
